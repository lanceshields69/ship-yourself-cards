...
export default function ShareButton({
  ...
  // Get category-specific share text if we're on a card page
  const getShareText = () => {
    if (pathname === "/cards") {
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 w-72 rounded-lg bg-white shadow-lg z-50 border"
          >
            <div className="p-4">
              ...
              <div className="flex items-center gap-2 border rounded-md p-2">
                ...
                <Button variant="ghost" size="sm" onClick={copyToClipboard} className="flex items-center gap-1 h-8">
                  {copied ? (
                    <>
